...
// taken from https://callstack.com/blog/reanimating-your-react-native-experience/
...
class CollapsibleNavHeaderWithSnap extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <View style={styles.container}>
        ...
        <Animated.View
          style={[
            styles.navBar,
            { transform: [{ translateY: this.animatedNavBarTranslateY }] },
          ]}
        >
          <Animated.Text
...
export default CollapsibleNavHeaderWithSnap;
